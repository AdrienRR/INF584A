...
BT_NODE::State BT_ACTION_BUILD_SUPPLY_PROVIDER::BuildSupplyProvider(void* data)
{
    ...
    if (supplyProviderType == BWAPI::UnitTypes::Zerg_Overlord)
    {
        ...
        startedBuilding = myDepot->train(supplyProviderType);
    }
    else
    {
        startedBuilding = Tools::BuildBuilding(supplyProviderType);
    }
