...
// 
//--------------------
class BT_DECO_CONDITION_HP_OVERLORD : public BT_DECO_CONDITION {
public:
    BT_DECO_CONDITION_HP_OVERLORD(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool HasEnoughHealth(void* data);
