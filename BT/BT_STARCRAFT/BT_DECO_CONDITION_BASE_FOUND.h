...
// 
//--------------------
class BT_DECO_CONDITION_BASE_FOUND : public BT_DECO_CONDITION {
public:
    BT_DECO_CONDITION_BASE_FOUND(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool FoundEnemyBase(void* data);
